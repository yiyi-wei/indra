package com.indra.cloud.order.config;

import com.indra.cloud.common.cache.adapter.CacheTtlAdapter;
import com.indra.cloud.common.cache.bo.CacheNameWithTtlBO;
import com.indra.cloud.common.cache.constant.OrderCacheNames;
